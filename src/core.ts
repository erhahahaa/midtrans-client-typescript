...
export interface BankTransfer extends Record<string, unknown> {
 ...
 */
export interface ChargeParameter extends Record<string, unknown> {
 ...
 * Capture parameter
 */
export interface CaptureParameter extends Record<string, unknown> {
 ...
 */
export interface CardRegisterParameter extends Record<string, unknown> {
	card_number: string;
 ...
 */
export interface CardTokenParameter extends Record<string, unknown> {
	card_number: string;
	card_exp_month: string;
	card_exp_year: string;
	card_cvv: string;
 ...
 */
export interface PaymentAccountParameter extends Record<string, unknown> {
	payment_type: PaymentType;
	gopay_partner?: {
		phone_number: string;
		country_code: string;
 ...
 */
export interface SubscriptionParameter extends Record<string, unknown> {
	name: string;
 ...
 * Charge response
 */
export interface ChargeResponse extends Record<string, unknown> {
	status_code: string;
...
export class CoreApi {
	 ...
	 */
	async cardRegister(
		parameter: CardRegisterParameter,
	 ...
	 * ```
	 */
	async cardPointInquiry(tokenId: string): Promise<unknown> {
	...
	async linkPaymentAccount(
		parameter: PaymentAccountParameter,
	): Promise<unknown> {
	 ...
	 * ```
	 */
	async getPaymentAccount(accountId: string): Promise<unknown> {
	 ...
	 * ```
	 */
	async unlinkPaymentAccount(accountId: string): Promise<unknown> {
