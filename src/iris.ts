 ...
 * Beneficiary details
 */
export interface BeneficiaryParameter extends Record<string, unknown> {
	name: string;
	account: string;
	bank: string;
	alias_name: string;
 ...
 * Payout parameter
 */
export interface PayoutParameter extends Record<string, unknown> {
	payouts: PayoutItem[];
}
 ...
 */
export interface PayoutApprovalParameter extends Record<string, unknown> {
 ...
 */
export interface TransactionHistoryParameter extends Record<string, unknown> {
	from_date?: string;
	to_date?: string;
}
 ...
 */
export interface BeneficiaryResponse extends Record<string, unknown> {
	status: string;
}
 ...
 */
export interface PayoutItemResponse extends Record<string, unknown> {
	status: string;
	reference_no: string;
}
...
export class Iris {
	 ...
	 * ```
	 */
	async getTopupChannels(): Promise<unknown> {
	 ...
	 * ```
	 */
	async getFacilitatorBankAccounts(): Promise<unknown> {
