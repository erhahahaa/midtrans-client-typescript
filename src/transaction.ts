 ...
 */
export interface NotificationObject extends Record<string, unknown> {
 ...
 * Refund parameters
 */
export interface RefundParameters extends Record<string, unknown> {
	refund_key?: string;
	amount?: number;
	reason?: string;
}
 ...
 */
export interface TransactionStatusResponse extends Record<string, unknown> {
	status_code: string;
